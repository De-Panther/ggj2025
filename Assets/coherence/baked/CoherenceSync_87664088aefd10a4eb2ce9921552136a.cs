...
namespace Coherence.Generated
{
    ...
    public class Binding_87664088aefd10a4eb2ce9921552136a_51f0428ad1e9471bb675560679a140b0 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_87664088aefd10a4eb2ce9921552136a : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_87664088aefd10a4eb2ce9921552136a>();
        ...
        {
            ["51f0428ad1e9471bb675560679a140b0"] = new Binding_87664088aefd10a4eb2ce9921552136a_51f0428ad1e9471bb675560679a140b0(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_87664088aefd10a4eb2ce9921552136a()
        {
        }
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            ...
            {
                default:
                    logger.Warning($"CoherenceSync_87664088aefd10a4eb2ce9921552136a Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_87664088aefd10a4eb2ce9921552136a>();
            this.bridge = bridge;
