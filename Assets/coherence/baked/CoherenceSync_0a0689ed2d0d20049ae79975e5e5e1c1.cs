...
namespace Coherence.Generated
{
    ...
    public class Binding_0a0689ed2d0d20049ae79975e5e5e1c1_34cd7b43b7084042b05f27d11192adb2 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_0a0689ed2d0d20049ae79975e5e5e1c1_385060728de74dca9394e8a02819e8e1 : RotationBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_0a0689ed2d0d20049ae79975e5e5e1c1 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_0a0689ed2d0d20049ae79975e5e5e1c1>();
        ...
        {
            ["34cd7b43b7084042b05f27d11192adb2"] = new Binding_0a0689ed2d0d20049ae79975e5e5e1c1_34cd7b43b7084042b05f27d11192adb2(),
            ["385060728de74dca9394e8a02819e8e1"] = new Binding_0a0689ed2d0d20049ae79975e5e5e1c1_385060728de74dca9394e8a02819e8e1(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_0a0689ed2d0d20049ae79975e5e5e1c1()
        {
        }
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            ...
            {
                default:
                    logger.Warning($"CoherenceSync_0a0689ed2d0d20049ae79975e5e5e1c1 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_0a0689ed2d0d20049ae79975e5e5e1c1>();
            this.bridge = bridge;
