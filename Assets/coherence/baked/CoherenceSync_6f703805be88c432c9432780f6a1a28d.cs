...
namespace Coherence.Generated
{
    ...
    public class Binding_6f703805be88c432c9432780f6a1a28d_4df48bb0443745da9a74f2087b27a0fc : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_6f703805be88c432c9432780f6a1a28d : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_6f703805be88c432c9432780f6a1a28d>();
        ...
        {
            ["4df48bb0443745da9a74f2087b27a0fc"] = new Binding_6f703805be88c432c9432780f6a1a28d_4df48bb0443745da9a74f2087b27a0fc(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_6f703805be88c432c9432780f6a1a28d()
        {
        }
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            ...
            {
                default:
                    logger.Warning($"CoherenceSync_6f703805be88c432c9432780f6a1a28d Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_6f703805be88c432c9432780f6a1a28d>();
            this.bridge = bridge;
