...
namespace Coherence.Generated
{
    ...
    public struct _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063.positionMask;
            positionSimulationFrame = frame;
            FieldsMask |= _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 28) {
            ...
            var orig = new _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063.positionMask) != 0 && (min == null || this.positionSimulationFrame < min))
            {
                min = this.positionSimulationFrame;
            }
            if ((FieldsMask & _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063)data;
        ...
        public static uint Serialize(_a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063.positionMask;
            }
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063.rotationMask;
            }
        ...
        {
            return $"_a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063(" +
