    ...
    public class DataInteropHandler : IDataInteropHandler
    {
        ...
        public unsafe void UpdateComponent(INativeCoreComponentUpdater updater, InteropEntity entity, ICoherenceComponentData component)
        {
            ...
            switch (componentType)
            {
                ...
                case 153:
                {
                    var orig = (_a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063)component;
                    var val = new _a94174c5022b2c64e8c4ba49a7cbbd0d_1966217122525543063.Interop();
        ...
        public unsafe IEntityCommand GetCommand(UInt32 type, IntPtr data, Int32 dataSize)
        {
            switch (type)
            {
                  ...
                  case 7: return _dbac35785ed561c428f6925098e216fa_620044fc95cf41068d8e01ab01bd2658.FromInterop(data, dataSize);
            }
        ...
        public unsafe bool SendCommand(INativeCoreCommandSender sender, InteropEntity entity, MessageTarget target, IEntityCommand command)
        {
            ...
            switch (type)
            {
                ...
                case 7:
                {
                    var orig = (_dbac35785ed561c428f6925098e216fa_620044fc95cf41068d8e01ab01bd2658)command;
                    var val = new _dbac35785ed561c428f6925098e216fa_620044fc95cf41068d8e01ab01bd2658.Interop();
